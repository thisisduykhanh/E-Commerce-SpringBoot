                    ...
                    <Card>
                        <Stack direction="row" spacing={3} sx={{ alignItems: 'center', px: 4, py: 3 }}>
                            ...
                            <Box sx={{ flex: '1 1 auto' }}>
                                ...
                                <Typography variant="h4">{new Intl.NumberFormat('vi-VN').format(32)}</Typography>
                            </Box>
                        </Stack>
                        <Divider />
                        <CardActions>
                    ...
                    <Card>
                        <Stack direction="row" spacing={3} sx={{ alignItems: 'center', px: 4, py: 3 }}>
                            ...
                            <Box sx={{ flex: '1 1 auto' }}>
                                ...
                                <Typography variant="h4">{new Intl.NumberFormat('vi-VN').format(21)}</Typography>
                            </Box>
                        </Stack>
                        <Divider />
                        <CardActions>
                    ...
                    <Card>
                        <Stack direction="row" spacing={3} sx={{ alignItems: 'center', px: 4, py: 3 }}>
                            ...
                            <Box sx={{ flex: '1 1 auto' }}>
                                ...
                                <Typography variant="h4">{new Intl.NumberFormat('vi-VN').format(4)}</Typography>
                            </Box>
                        </Stack>
                        <Divider />
                        <CardActions>
