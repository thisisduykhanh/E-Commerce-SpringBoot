                    ...
                    <Stack spacing={2}>
                        <Stack direction="row" spacing={2} sx={{ justifyContent: 'space-between' }}>
                            ...
                            <Typography variant="subtitle2">
                                {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(119)}
                            </Typography>
                        </Stack>
                        <Stack direction="row" spacing={2} sx={{ justifyContent: 'space-between' }}>
                            <Typography variant="subtitle2">Shipping tax</Typography>
                            <Typography variant="subtitle2">
                                {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(20)}
                            </Typography>
                        </Stack>
                        <Divider />
                        <Stack direction="row" spacing={2} sx={{ justifyContent: 'space-between' }}>
                            ...
                            <Typography variant="subtitle2">
                                {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(139)}
                            </Typography>
                        </Stack>
                    </Stack>
                </Stack>
