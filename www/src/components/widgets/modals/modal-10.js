...
export function Modal10() {
    return (
        <Box sx={{ bgcolor: 'var(--mui-palette-background-level1)', p: 3 }}>
            <Container maxWidth="sm">
                <Paper
                    sx={{ border: '1px solid var(--mui-palette-divider)', boxShadow: 'var(--mui-shadows-16)', p: 3 }}
                >
                    <Stack spacing={3}>
                        ...
                        <Stack spacing={3}>
                            ...
                            <Stack direction="row" spacing={3}>
                                <Button color="secondary" sx={{ flex: '1 1 auto' }}>
                                    Close
                                </Button>
                                <Button color="error" sx={{ flex: '1 1 auto' }} variant="contained">
                                    Refund
                                </Button>
                            </Stack>
                        </Stack>
