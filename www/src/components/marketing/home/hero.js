                ...
                <Stack spacing={4}>
                    <Stack spacing={2}>
                        ...
                        <Typography color="neutral.300" sx={{ fontWeight: 400, textAlign: 'center' }} variant="h5">
                            Premium template designed to accelerate app development with a stunning design and powerful
                    ...
                    <Stack direction="row" spacing={1} sx={{ alignItems: 'center', justifyContent: 'center ' }}>
                        <AvatarGroup
                            sx={{ '& .MuiAvatar-root': { border: '2px solid var(--mui-palette-neutral-950)' } }}
                        >
