                        ...
                        >
                            <Stack spacing={2}>
                                ...
                                <Typography color="inherit">
                                    Our interactive dashboard provides an all-encompassing view of your projects, tasks,
                                    and collaborations. Monitor deadlines, track milestones, and stay updated on team
                                    activities.
                                </Typography>
                                <div>
                                    <Button
