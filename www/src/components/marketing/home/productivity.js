                ...
                <Stack >
                    <Stack maxWidth="700px" spacing={2} sx={{ mx: 'auto' }}>
                        ...
                        <Typography color="text.secondary" sx={{ textAlign: 'center' }}>
                            Our template is wonderfully simple and user-friendly. It&apos;s easy to love when you focus
                            on essentials and skip non-critical extras.
                        </Typography>
                    </Stack>
                            ...
                            >
                                <Stack spacing={2} sx={{ p: 4 }}>
                                    ...
                                    <Typography color="text.secondary" variant="body2">
                                        Each template is a well-structured Vite & Next.js project, adhering to MUI best
                                        practices. All code is written by our in-house team of experts.
                                    </Typography>
                                </Stack>
                        ...
                        >
                            ...
                            >
                                <Stack spacing={2} sx={{ p: 4 }}>
                                    ...
                                    <Typography color="text.secondary" variant="body2">
                                        Every template provides a thoughtfully structured project, offering a codebase
                                        that&apos;s not only productive but also a joy to work with.
                                    </Typography>
                                </Stack>
                                <Box sx={{ height: '300px', position: 'relative' }}>
                                    <NoSsr>
                                        <Box
                                            ...
                                            src={
                                                colorScheme === 'dark'
                                                    ? '/assets/home-feature-4-dark.png'
                                                    : '/assets/home-feature-4-light.png'
                                            }
                                            sx={{
                                                bottom: 0,
                                                height: 'auto',
