...
const tabs = [
    { label: 'Tất cả', value: '', count: 5 },
    { label: 'Đã đăng', value: 'published', count: 3 },
    { label: 'Nháp', value: 'draft', count: 2 },
];
...
function CategoryFilterPopover() {
    ...
    return (
        <FilterPopover anchorEl={anchorEl} onClose={onClose} open={open} title="Lọc theo danh mục">
            <FormControl>
                <Select
                    onChange={(event) => {
