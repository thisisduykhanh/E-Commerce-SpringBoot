                                            ...
                                            <Controller
                                                ...
                                                render={({ field }) => (
                                                    <FormControl error={Boolean(errors.name)} fullWidth={true}>
                                                        <InputLabel required={true}>Product name</InputLabel>
                                                        <OutlinedInput {...field} />
                                                        {errors.name ? (
                                    ...
                                    <Grid container={true} spacing={3}>
                                        ...
                                        >
                                            <Controller
                                                ...
                                                name="sku"
                                                render={({ field }) => (
                                                    <FormControl error={Boolean(errors.sku)} fullWidth={true}>
                                        ...
                                        >
                                            <Controller
                                                ...
                                                name="barcode"
                                                render={({ field }) => (
                                                    <FormControl error={Boolean(errors.barcode)} fullWidth={true}>
                                        ...
                                        >
                                            <Controller
                                                ...
                                                name="quantity"
                                                render={({ field }) => (
                                                    <FormControl error={Boolean(errors.quantity)} fullWidth={true}>
                                        ...
                                        >
                                            <Controller
                                                ...
                                                name="height"
                                                render={({ field }) => (
                                                    <FormControl error={Boolean(errors.height)} fullWidth={true}>
                                        ...
                                        >
                                            <Controller
                                                ...
                                                name="width"
                                                render={({ field }) => (
                                                    <FormControl error={Boolean(errors.width)} fullWidth={true}>
                                        ...
                                        >
                                            <Controller
                                                ...
                                                name="length"
                                                render={({ field }) => (
                                                    <FormControl error={Boolean(errors.length)} fullWidth={true}>
                            ...
                            <CardContent>
                                <Stack spacing={2}>
                                    ...
                                    <div>
                                        ...
                                        <Typography
                                            color={category ? 'text.secondary' : 'text.disabled'}
                                            variant="body2"
                                        >
                        ...
                        <Stack spacing={2}>
                            ...
                            {tags ? (
                                <Typography variant="subtitle2">
                                    Keywords: {tags.split(',').filter(Boolean).join(', ')}
                                </Typography>
                            ) : (
                                <Box
                                    sx={{
