            ...
            items: [
              ...
              /*   {
                ...
                // { key: 'products', title: 'Sản phẩm', href: paths.supplier.products.list, icon: 'shopping-bag-open' },
                {
                    ...
                    items: [
                        { key: 'products', title: 'Danh sách sản phẩm', href: paths.supplier.products.list },
                        { key: 'products:create', title: 'Tạo sản phẩm', href: paths.supplier.products.create },
                        // {
                ...
                // { key: 'orders', title: 'Đơn hàng', href: paths.supplier.orders.list, icon: 'shopping-cart-simple' },
                {
                    ...
                    items: [
                        { key: 'orders', title: 'Danh sách đơn hàng', href: paths.supplier.orders.list },
                        // { key: 'orders:create', title: 'Tạo đơn hàng', href: paths.supplier.orders.create },
                        // {
                        //     key: 'orders:details',
