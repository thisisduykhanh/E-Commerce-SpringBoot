            ...
            <Page size="A4" style={styles.page}>
                ...
                <View>
                    <Text style={[styles.textLg, styles.fontSemibold]}>
                        {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(19.99)} due{' '}
                ...
                <View>
                    ...
                    <View>
                        ...
                        <View style={styles.summaryRow}>
                            ...
                            <View style={styles.summaryValue}>
                                <Text style={styles.textRight}>
                                    {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(5)}
                                </Text>
                            </View>
                        </View>
                        <View style={styles.summaryRow}>
                ...
                <View>
                    ...
                    <Text>
                        Please make sure you have the right bank registration number as I had issues before and make
                        sure you cover transfer expenses.
                    </Text>
                </View>
            </Page>
        </Document>
