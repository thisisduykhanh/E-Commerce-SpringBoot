...
export default function Header() {
        ...
        const fetchUser = async () => {
            ...
            try {
                ...
                if (response?.data) {
                    ...
                    logger.warn('Response received but no user data available:', response);
                }
            } catch (error) {
    ...
    return (
        <AppBar
            position="static"
            sx={{ background: '#ffffff !important', boxShadow: 'none', padding: 0, paddingLeft: 0, paddingRight: 0 }}
        >
            <Toolbar
                sx={{
                    padding: 0,
            ...
            >
                ...
                >
                  <Button
                    ...
                    <Divider orientation="vertical" flexItem sx={{ borderColor: '#666666', margin: '0 10px',opacity: 0.5, }} />
                    <Button
                        variant="text"
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 400" width="20" height="20">
            ...
            >
                ...
                >
                    {user ? (
                        <>
                            <Button
                                sx={{ color: '#666666', fontWeight: 'bold', fontSize: '16px', marginRight: '10px' }}
                            ...
                            <Button
                                ...
                                sx={{ color: '#666666', textTransform: 'none', fontWeight: 'bold', fontSize: '16px' }}
                            >
