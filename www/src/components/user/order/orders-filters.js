...
const tabs = [
    ...
    { label: 'Đã Duyệt', value: "Access", count: 1 },
    { label: 'Từ Chối', value: "Reject", count: 2 },
    { label: 'Hoàn Thành', value: "Success", count: 2 },
    //   { label: 'Huỷ', value: 'canceled', count: 1 },
    //   { label: 'Từ chối', value: 'rejected', count: 1 },
];
