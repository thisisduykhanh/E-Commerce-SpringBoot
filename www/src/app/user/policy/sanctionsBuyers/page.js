...
function SanctionsBuyers() {
    const title = 'CHẾ TÀI VÀ HƯỚNG XỬ LÝ BÊN MUA';
    const content = (
        <>
            ...
            <ul>
                ...
                <li>Không thanh toán đơn hàng</li>
                <li>Gây rối hoặc có hành vi không đúng mực với nhà cung cấp</li>
            ...
            <Typography variant="h6" sx={{ marginTop: 4, fontWeight: 'bold' }}>
                4. QUYỀN VÀ TRÁCH NHIỆM CỦA NGƯỜI MUA
            </Typography>
            <Typography variant="body1" sx={{ marginTop: 2 }}>
                Người mua có quyền và trách nhiệm sau:
            </Typography>
            <ul>
...
export default SanctionsBuyers;
