...
function ProductDetailPage() {
    ...
    const reviews = [
        ...
        },
        {
            ...
            avatar: '',
            rating: 4.5,
            comment: 'Proin sit amet nisl nec leo tincidunt vulputate. Integer ut quam id augue fermentum.',
            time: '1 day ago',
        },
        {
            id: 6,
            ...
            avatar: '',
            rating: 4,
            comment: 'Curabitur eget tortor sapien. Maecenas facilisis justo sit amet nunc tincidunt, ac iaculis.',
            time: '5 hours ago',
        },
        {
            id: 7,
        ...
        },
        {
            ...
            avatar: '',
            rating: 5,
            comment: 'Suspendisse nec purus volutpat, feugiat mi eget, tristique lorem.',
            time: '6 days ago',
        },
        {
            id: 9,
        ...
        },
        {
            ...
            avatar: '',
            rating: 4,
            comment: 'Aliquam erat volutpat. Pellentesque habitant morbi tristique senectus et netus et malesuada.',
            time: '10 days ago',
        },
        {
            id: 11,
        ...
        },
        {
            ...
            avatar: '',
            rating: 4.5,
            comment: 'Vivamus gravida nulla sit amet enim ultricies, ac suscipit ligula bibendum.',
            time: '1 month ago',
        },
        {
            id: 14,
            ...
            avatar: '',
            rating: 4,
            comment: 'Suspendisse potenti. Curabitur in ligula et velit pharetra vehicula.',
            time: '2 months ago',
        },
        {
            id: 15,
    ...
    useEffect(() => {
        if (productDetail?.officialPriceDTO?.length) {
            const quantities = productDetail.officialPriceDTO.map((price) => ({
                min: price.minQuantity,
                max: price.maxQuantity,
            }));
            setMinQuantity(Math.min(...quantities.map((q) => q.min)));
            setMaxQuantity(Math.max(...quantities.map((q) => q.max)));
        }
    }, [productDetail]);

    useEffect(() => {
        if (productDetail?.officialPriceDTO && Array.isArray(productDetail.officialPriceDTO)) {
            const prices = productDetail.officialPriceDTO.map((item) => item.price);
                    ...
                    <Box sx={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
                        ...
                        <Box sx={{ marginBottom: '20px' }}>
                            <Typography variant="body1" marginBottom="20px">
                                Số lượng đặt tối thiểu: <span style={{ fontWeight: 'bold' }}>{minQuantity}</span>
                            </Typography>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <IconButton
                                        ...
                                        sx={{
                                            ...
                                            borderRadius: '30px',
                                            backgroundColor: '#FAFAFA !important',
                                            color: quantity > maxQuantity ? ' #E0E0E0' : '#757575 !important',
                                        }}
                                    >
                                        <AddIcon />
                                    </IconButton>
                                ...
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        borderRadius: '30px',
                                        width: '100%',
                                        background: quantity >= minQuantity ? '#00A6B7' : '#E0E0E0',
                                        color: quantity >= minQuantity ? '#fff' : '#000 !important',
                                        borderColor: '#00A6B7',
                                        cursor: quantity >= minQuantity ? 'pointer' : 'not-allowed !important',
                                    }}
                ...
                <Box>
                    ...
                    <Box>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Grid item={true} xs={12} sm={6}>
                                        ...
                                        <Typography variant="body1" sx={{ marginBottom: '8px' }}>
                                            <strong>Loại kho:</strong> {productDetail?.warehouseType || 'Không có'}
                                        </Typography>
                                        <Typography variant="body1" sx={{ marginBottom: '8px' }}>
                                    ...
                                    <Grid item={true} xs={12} sm={6}>
                                        ...
                                        <Typography variant="body1" sx={{ marginBottom: '8px' }}>
                                            <strong>Kích thước:</strong> {productDetail?.size || 'Không có'}
                                        </Typography>
                                    </Grid>
                                </Grid>

                                {/* Packaging Details */}
                                <Box sx={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid #ddd' }}>
                                    <Typography variant="body1" sx={{ marginBottom: '8px' }}>
                            ...
                            <Box sx={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
                                ...
                                {currentData.map((review, index) => (
                                    <Box key={review.id} sx={{ marginBottom: '20px' }}>
                                        ...
                                        {/* Nội dung đánh giá */}
                                        <Typography variant="body2" color="#555" sx={{ marginBottom: '10px' }}>
                                            {review.comment}
                                        </Typography>

                                        {/* Đường kẻ ngăn cách */}
                                        {index < currentData.length - 1 && <Divider sx={{ marginTop: '10px' }} />}
                                    </Box>
                                ))}
                        ...
                        {activeTab === 2 && (
                            <Box sx={{ padding: '20px' }}>
                                <Typography variant="body1">
                                    Công ty TNHH Vinipr Media chuyên cung cấp các loại rau cải hữu cơ, đảm bảo chất
                                    lượng
                                </Typography>
                            </Box>
                        )}
                        {activeTab === 3 && (
                            <Typography variant="body1">
                                Chứng nhận sản phẩm: Sản phẩm đạt tiêu chuẩn hữu cơ 100%, chứng nhận bởi tổ chức quốc
                                tế.
                            </Typography>
                        )}
                    </Box>
