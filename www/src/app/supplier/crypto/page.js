                    ...
                    <Grid size={12}>
                        ...
                        >
                            <DigitalWallet
                                ...
                                currency="BTC"
                                data={[
                                    56, 61, 64, 60, 63, 61, 60, 68, 66, 64, 77, 60, 65, 51, 72, 80, 74, 67, 77, 83, 94,
                                    95, 89, 100, 94, 104, 101, 105, 104, 103, 107, 120,
                                ]}
                                diff={34.1}
                                trend="up"
                                value={16213.2}
                            ...
                            <DigitalWallet
                                ...
                                currency="ETH"
                                data={[
                                    65, 64, 70, 76, 82, 80, 85, 78, 82, 95, 93, 80, 112, 102, 105, 95, 98, 102, 104, 99,
                                    101, 100, 109, 106, 111, 105, 108, 102, 118, 129,
                                ]}
                                diff={14.2}
                                trend="up"
                                value={9626.8}
                            ...
                            <DigitalWallet
                                ...
                                currency="BNB"
                                data={[
                                    99, 101, 104, 98, 99, 99, 102, 103, 100, 101, 99, 101, 101, 98, 95, 97, 98, 92, 94,
                                    93, 95, 82, 78, 75, 80, 78, 76, 54, 45, 32, 31, 27,
                                ]}
                                diff={18}
                                trend="down"
                                value={6640}
