...
export const paths = {
    ...
    auth: {
        ...
        seller: {
            signIn: '/auth/seller/sign-in',
            signUp: '/auth/seller/sign-up',
            resetPassword: '/auth/seller/reset-password',
        },
        auth0: {
    ...
    dashboard: {
        ...
        suppliers: {
            ...
            details: (supplierId) => `/dashboard/suppliers/${supplierId}`,
        },
    ...
    supplier: {
        products: {
            ...
            preview: (productId) => `/supplier/products?previewId=${productId}`,
            details: (productId) => `/supplier/products/${productId}`,
            update: (productId) => `/supplier/products/update?previewId=${productId}`,
        },
        orders: {
            list: '/supplier/orders',
            create: '/supplier/orders/create',
            preview: (orderId) => `/supplier/orders?previewId=${orderId}`,
    ...
    //     shipping: '/user/policy/ShipingPolicy',
    //     payment: '/user/policy/PaymentPolicy',
    //     privacy: '/user/policy/PrivacyPolicy',
    //     compensation: '/user/policy/CompensationPolicy',
    // },
};
